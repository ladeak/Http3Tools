...
public class ChannelsPriorityResponseWriterTests
{
    [Fact]
    ...
    private static (TestDuplexPipe Pipe, CHttp2ConnectionContext Context, ChannelsPriorityResponseWriter Writer) CreateResponseWriter()
    {
