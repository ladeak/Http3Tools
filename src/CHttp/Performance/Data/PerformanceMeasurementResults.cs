...
{
    public static PerformanceMeasurementResults Default { get; } = new PerformanceMeasurementResults() { Summaries = Array.Empty<Summary>(), TotalBytesRead = 0, Behavior = new(0, 0, false) };
