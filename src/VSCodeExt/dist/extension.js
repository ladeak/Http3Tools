...
class RequestController {
    ...
    async run(range) {
        ...
        if (metadatas.has(requestMetadata_1.RequestMetadata.Note)) {
            ...
            const userConfirmed = await vscode_1.window.showWarningMessage(note, 'Yes', 'No');
...
const fileVariableProvider_1 = __webpack_require__(10);
const workspaceUtility_1 = __webpack_require__(12);
...
const os_1 = __webpack_require__(6);
const mimeUtility_1 = __webpack_require__(16);
const misc_1 = __webpack_require__(20);
const requestParserUtil_1 = __webpack_require__(22);
var ParseState;
(function (ParseState) {
...
const mime = __webpack_require__(17);
class MimeType {
